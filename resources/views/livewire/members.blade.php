...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <button wire:click="create()" type="button" class="mb-5 bg-green-500 hover:bg-red-700 text-black font-bold py-2 px-4 rounded">Tambah Anggota</button>
                    ...
                    @forelse($members as $row)
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                ...
                                <button wire:click="delete({{ $row->id }})" class="bg-red-500 hover:bg-red-700 text-black font-bold py-2 px-4 rounded">Hapus</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
